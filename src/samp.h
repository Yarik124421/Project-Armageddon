...
#define SAMP_SHOWPLAYERDIALOG						(samp_base + 0xB050)
#define SAMP_TOGGLEPLAYERCONTROL					(samp_base + 0x13E90)
...
extern char						szPatchesFileName[MAX_PATH];
extern char						szCMFileName[MAX_PATH];
